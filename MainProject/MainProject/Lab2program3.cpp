...
//	// wczytanie tekstury merkury  utworzonej ze zdjęć sondy asd
//	
//	GLboolean error = load_targa("mercury.tga", width, height, format, type, pixels);
//	if (error == GL_FALSE)
//	{
//		printf("Niepoprawny odczyt pliku mer0muu2.jpg");
//		exit(0);
//	}
